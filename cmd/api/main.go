...
import (
	...
	"github.com/Nourbol/breed/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("BREED_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.password, "smtp-password", os.Getenv("BREED_SMTP_PASSWORD"), "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Breed <211477@astanait.edu.kz>", "SMTP sender")
